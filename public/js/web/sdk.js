                ...
                __d("ES7ArrayPrototype", ["ES5Array", "ES5ArrayPrototype"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    a = {
                        includes: function(a) {
                            "use strict";
                            __p && __p();
                            if (a !== undefined && i(this) && !(typeof a === "number" && isNaN(a)))
 ...
 */
                ...
                __d("ES", ["ES5Array", "ES5ArrayPrototype", "ES5Date", "ES5FunctionPrototype", "ES5Object", "ES5StringPrototype", "ES6Array", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number", "ES6Object", "ES7ArrayPrototype", "ES7Object", "ES7StringPrototype", "json3"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function b(a, b, c) {
                        ...
                        if (typeof e === "function") {
                            for (var f = arguments.length, g = new Array(f > 3 ? f - 3 : 0), h = 3; h < f; h++)
                                g[h - 3] = arguments[h];
                            return e.apply(a, g)
                        } else if (e)
                            return e;
                    ...
                    var g = a.FB_enumerate
                      , h = function() {
                        ...
                        function x(b) {
                            if (b[w])
                                return b[w];
                            else if (!a.__isES5 && b.propertyIsEnumerable && b.propertyIsEnumerable[w])
                                return b.propertyIsEnumerable[w];
                            else if (!a.__isES5 && e(b) && v(b))
                                return v(b);
                            else if (!a.__isES5 && b[w])
                                return b[w]
                        }
                        var y = function() {
                ...
                __d("eprintf", [], (function(a, b, c, d, e, f) {
                    ...
                    function g(a) {
                        ...
                        if (f !== e.length)
                            return g("eprintf args number mismatch: %s", ES("JSON", "stringify", !1, [a].concat(e)));
                        var h = 0;
                ...
                __d("ManagedError", [], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, b) {
                        ...
                        a !== null && a !== undefined ? this.message = a : this.message = "",
                        this.innerError = b
                    }
                    e.exports = a
                }
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    function j(a, b, c, d) {
                        ...
                        d = d ? ";Secure" : "";
                        var e = i !== null && i !== ".";
                        e && (document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT" + d,
                        document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;domain=" + location.hostname + d);
                ...
                __d("sdk.domReady", [], (function(a, b, c, d, e, f) {
                    ...
                    if (!b) {
                        ...
                        window.addEventListener("load", h, !1)) : document.attachEvent && (document.attachEvent("onreadystatechange", h),
                ...
                __d("sdk.Content", ["Log", "sdk.domReady", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    var j, k = {
                        append: function(a, b) {
                            b || (!j ? (j = b = document.getElementById("fb-root"),
                            b || (g.warn('The "fb-root" div has not been created, auto-creating'),
                            j = b = document.createElement("div"),
                            b.id = "fb-root",
                            i.ie() || !document.body ? h(function() {
                                document.body.appendChild(b)
                            }) : document.body.appendChild(b)),
                            b.className += " fb_reset") : b = j);
                            if (typeof a === "string") {
                ...
                __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    function o(a) {
                        ...
                        if (c.length > 2e3 && (a.payload && typeof a.payload === "string")) {
                            ...
                            d && d.length < a.payload.length && (a.payload = d,
                            c = h.appendToUrl(b, a))
                        }
                        if (c.length <= 2e3) {
                            d = new Image();
                ...
                __d("URIBase", ["URIRFC3986", "URISchemes", "ex", "invariant", "setHostSubdomain"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function n(a, b, c, d) {
                        ...
                        if (e.userinfo !== null)
                            if (c)
                                throw new Error(i("URI.parse: invalid URI (userinfo is not allowed in a URI): %s", a.toString()));
                            else
                                return !1;
                        if (!a.getDomain() && ES(a.getPath(), "indexOf", !0, "\\") !== -1)
                            if (c)
                                throw new Error(i("URI.parse: invalid URI (no domain but multiple back-slashes): %s", a.toString()));
                            else
                                return !1;
                        if (!a.getProtocol() && m.test(b))
                            if (c)
                                throw new Error(i("URI.parse: invalid URI (unsafe protocol-relative URLs): %s", a.toString()));
                            else
                                return !1;
                        if (a.getDomain() && a.getPath() && !ES(a.getPath(), "startsWith", !0, "/"))
                            if (c)
                                throw new Error(i("URI.parse: invalid URI (domain and path where path lacks leading slash): %s", a.toString()));
                            else
                                return !1;
                        return !0
                    }
                    ...
                    p.prototype.setDomain = function(a) {
                        "use strict";
                        if (l.test(a))
                            throw new Error(i("URI.setDomain: unsafe domain specified: %s for url %s", a, this.toString()));
                        this.$1 = a;
                        return this
                    }
                    ;
                ...
                __d("Queue", [], (function(a, b, c, d, e, f) {
                    ...
                    h.prototype._dispatch = function(a) {
                        ...
                        if (this._opts.interval)
                            ...
                            this._timeout = setTimeout(ES(this._dispatch, "bind", !0, this), this._opts.interval);
                        else
                ...
                __d("Flash", ["DOMWrapper", "QueryString", "UserAgent_DEPRECATED", "guid", "htmlSpecialChars", "sdk.DOMEventListener"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = {}, n, o = g.getWindow().document;
                    function p(a) {
                    ...
                    function s(a) {
                        n || (i.ie() >= 9 && l.add(window, "unload", q),
                        n = !0),
                        m[a] = a
                    }
                    var t = {
                        embed: function(a, b, c, d) {
                            ...
                            d = [];
                            for (var f in c)
                                Object.prototype.hasOwnProperty.call(c, f) && c[f] && d.push('<param name="' + k(f) + '" value="' + k(c[f]) + '">');
                        ...
                        getVersion: function() {
                            ...
                            if (!d)
                                try {
                                    d = new ActiveXObject(c).GetVariable("$version").match(/(\d+),(\d+),(\d+),(\d+)/),
                ...
                __d("XDM", ["DOMWrapper", "Flash", "GlobalCallback", "Log", "UserAgent_DEPRECATED", "emptyFunction", "guid", "sdk.DOMEventListener", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    a = {
                        ...
                        create: function(a) {
                            ...
                            a.channel || (j.warn("Missing channel name, selecting at random"),
                            a.channel = m());
                        ...
                        return {
                            ...
                            init: function(b) {
                                ...
                                n.add(r, "message", o(function(event) {
                                    ...
                                    if (d !== "native" && !(t.test(location.hostname) || t.test(event.origin)))
                                        return;
                                    if (typeof a !== "string") {
                    ...
                    a.prototype.stub = function(a) {
                        ...
                        this.remote[a] = ES(function() {
                            ...
                            for (var c = arguments.length, d = new Array(c), e = 0; e < c; e++)
                                d[e] = arguments[e];
                            typeof d[d.length - 1] === "function" && (b.id = ++this.$1,
                            this.$2[b.id] = d.pop());
                            b.params = d;
                ...
                __d("sdk.createIframe", ["getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike", "sdk.DOMEventListener"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function a(a) {
                        ...
                        var b, c = a.name || h(), d = a.root, e = a.style || {
                            border: "none"
                        }, f = a.url, l = a.onload, m = a.onerror;
                        i() ? b = document.createElement('<iframe name="' + c + '"/>') : (b = document.createElement("iframe"),
                        b.name = c);
                        delete a.style;
                        delete a.name;
                        delete a.url;
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    ;
                    var B = m(), C = c(), D, E, F = !1, G = "Facebook Cross Domain Communication Frame", H = {}, I = new j();
                    s.setInQueue(I);
                    function J(a) {
                    ...
                    function M(a, b) {
                        if (a == "facebook")
                            ...
                            var c = H[a];
                            c ? (h.debug("Enqueuing message for plugin %s in %s", a, c.protocol + "ProxyQueue"),
                            x.enqueue(b)) : (h.debug("Buffering message for plugin %s", a),
                            j.get(a).enqueue(b))
                        }
                    }
                ...
                __d("sdk.Auth", ["DOMWrapper", "Log", "OAuthControllerParameterName", "ObservableMixin", "UrlMap", "guid", "sdk.Cookie", "sdk.createIframe", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.WebStorage", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
                    ...
                    function D(a, b) {
                        ...
                        e = r.getLoginStatus();
                        var f = e === "unknown" && a || r.getUseCookie() && r.getCookieUserID() !== d
                          , g = c && !a;
                        c = a && c && c != d;
                        var h = a != A;
                        e = b != (e || "unknown");
                    ...
                    function F(a, b, c) {
                        ...
                        return function(d) {
                            ...
                            if (d && d.access_token) {
                                ...
                                (c === "logout" || c === "login_status") && (d && d.error && d.error === "not_authorized" ? (g = "not_authorized",
                                D(null, g)) : d && d.error && d.error === "authorization_expired" ? (g = "authorization_expired",
                                D(null, g)) : (g = "unknown",
                                D(null, g)),
                ...
                __d("sdk.ErrorHandler", ["ManagedError", "normalizeError", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a, b) {
                        ...
                        a && (setTimeout = k(setTimeout, "setTimeout"),
                ...
                __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function t(a, b, c, d) {
                        ...
                        return p.guard(function() {
                            ...
                            var f = ES(Array.prototype.slice.call(arguments), "map", !0, e), g = a.apply(d, f), h, i = !0;
                    ...
                    function a(a, b) {
                        ...
                        ES(ES("Object", "keys", !1, b), "forEach", !0, function(d) {
                            ...
                            if (typeof e === "function") {
                                ...
                                (typeof e === "object" || typeof e === "number") && (c[d] = e)
                        })
                    }
                ...
                __d("ApiBatcher", ["ApiClientUtils", "QueryString", "invariant", "sdk.safelyParseResponse"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    m.prototype.scheduleBatchCall = function() {
                        ...
                        this.$1.push(i);
                        this.$2.push(f);
                        this.$1.length == k ? (this.$4 && clearTimeout(this.$4),
                        this.$5()) : this.$4 || (this.$4 = setTimeout(ES(function() {
                            this.$5()
                        }, "bind", !0, this), 0))
                    }
                    ;
                    m.prepareBatchParams = function(a) {
                        ...
                        a.toLowerCase() == "post" && (d = h.encode(b.getQueryData()),
                ...
                __d("sdk.PlatformVersioning", ["ManagedError", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    a = {
                        ...
                        assertValidVersion: function(a) {
                            if (!i.test(a))
                                throw new g("invalid version specified")
                        }
                    };
                    e.exports = a
                }
                ...
                __d("sdk.unsecureDisallowed", ["Log", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    function a(a) {
                        ...
                        location.protocol !== "https:" && k && (g.log("error", -1, "The method FB.%s will soon stop working when called from http pages. Please update your site to use https for Facebook Login. %s", a, l),
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Auth", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    function L(a) {
                        ...
                        for (var b in a)
                            h.isTrue(t.test(b) || ES(z, "includes", !0, b), "Invalid user properties key name: " + b + ". It must be between 1 and " + u + " characters, and must contain only alphanumerics, _, - or spaces, starting with alphanumeric or _. Or, it must be a pre-defined user property"),
                    ...
                    k.subscribe("init:post", function(a) {
                        n.getClientID() && (a.autoLogAppEvents !== undefined && (h.isBoolean(a.autoLogAppEvents, "Type of property autoLogAppEvents must be boolean"),
                        n.setAutoLogAppEvents(a.autoLogAppEvents)),
                        n.getAutoLogAppEvents() && F(n.getClientID()))
                    });
                    e.exports = {
                        activateApp: b,
                        logEvent: D,
                    ...
                    a = {
                        ...
                        addIdleDesktopAction: function(a, b, c) {
                            ...
                            return i.add(a, "mouseenter", function() {
                                clearTimeout(d),
                                event || (event = i.add(a, "mouseleave", function() {
                                    e()
                                }))
                            })
                        },
                        ...
                        setDialogPositionToCenter: function(a, b, c) {
                            ...
                            if (j.mobile()) {
                                c = 100;
                                b ? (c += (e.height - d) / 2,
                                h.addCss(document.body, "fb_reposition")) : (h.addCss(document.body, "fb_hidden"),
                    ...
                    var w = h.extend({
                      ...
                      , x = {
                        ...
                        _showTabletOverlay: function(a) {
                            if (!x.isTabletStyle())
                                return;
                            x._overlayEl || (x._overlayEl = k.setupNewDarkOverlay(),
                        ...
                        _hideTabletOverlay: function() {
                            x.isTabletStyle() && (x._overlayEl.className = "hidden",
                        ...
                        _makeActive: function(a) {
                            ...
                            x._lowerActive(),
                            x._active = a,
                            o.isEnvironment(o.ENVIRONMENTS.CANVAS) && i.getPageInfo(function(a) {
                                x._centerActive(a)
                            }),
                            x._centerActive()
                        },
                        ...
                        _setDialogSizes: function(a) {
                            ...
                            for (var b in x._dialogs)
                                if (Object.prototype.hasOwnProperty.call(x._dialogs, b)) {
                                    ...
                                    c && (c.style.width = x.getDefaultSize().width + "px",
                                    a || (c.style.height = x.getDefaultSize().height + "px"))
                                }
                        },
                        ...
                        show: function(a) {
                            var b = x._findRoot(a);
                            b && (x._removeStacked(b),
                            x._hideLoader(),
                            x._makeActive(b),
                            x._stack.push(b),
                            "fbCallID"in a && x.get(a.fbCallID).inform("iframe_show").trackEvent("show"))
                        },
                        hide: function(a) {
                            var b = x._findRoot(a);
                            x._hideLoader();
                            b == x._active && (x._lowerActive(),
                            k.onDialogHideCleanup(x.isTabletStyle()),
                            x._hideTabletOverlay(),
                            "fbCallID"in a && x.get(a.fbCallID).inform("iframe_hide").trackEvent("hide"))
                        },
                        remove: function(a) {
                            a = x._findRoot(a);
                            if (a) {
                                ...
                                x._removeStacked(a);
                                b ? (x._hideLoader(),
                                x._stack.length > 0 ? x.show(x._stack.pop()) : (x._lowerActive(),
                                k.onDialogHideCleanup(x.isTabletStyle()),
                    ...
                    var k = {
                        ...
                        _processRequestResponse: function(a, b) {
                            return function(c) {
                                ...
                                c && (!b && c.frictionless && (i._hideLoader(),
                ...
                __d("sdk.openMessenger", ["sdk.UA"], (function(a, b, c, d, e, f, g) {
                    ...
                    function a(a) {
                        var b, c, d = a.link;
                        a = a.app_id;
                        g.android() ? (b = "intent://share/#Intent;package=com.facebook.orca;scheme=fb-messenger;S.android.intent.extra.TEXT=" + encodeURIComponent(d) + ";S.trigger=send_plugin;",
                        a && (b += "S.platform_app_id=" + encodeURIComponent(a) + ";"),
                        b += "end",
                        c = i) : (b = "fb-messenger://share?link=" + encodeURIComponent(d),
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E) {
                    ...
                    a = {
                        ...
                        apprequests: {
                            transform: function(a) {
                                ...
                                a.params.frictionless && (w.isAllowed(a.params.to) && (a.params.display = "iframe",
                                a.params.in_iframe = !0,
                                a.hideLoader = !0),
                                a.cb = w._processRequestResponse(a.cb, a.hideLoader));
                                a.closeIcon = !1;
                                return a
                            },
                        ...
                        "auth.logout": {
                            ...
                            transform: function(a) {
                                if (!B.getClientID())
                                    g.error("FB.logout() called before calling FB.init().");
                                else if (!o.getAuthResponse())
                                    g.error("FB.logout() called without an access token.");
                                else {
                    ...
                    var M = {
                        ...
                        prepareCall: function(a, b) {
                            ...
                            (c === "share" || c === "share_open_graph") && (a.mobile_iframe = D.mobile() && (a.mobile_iframe || a.iframe_test),
                            a.mobile_iframe && (d = ES("Object", "assign", !1, {}, F)));
                        ...
                        popup: function(a) {
                            ...
                            c.push("top=" + d);
                            c.push("scrollbars=1");
                            (a.name == "permissions.request" || a.name == "permissions.oauth") && (c.push("toolbar=0"),
                            (!D.chrome() || D.chrome() < 59) && c.push("location=1"));
                            e = c.join(",");
                            a.post ? (f = window.open("about:blank", a.id, e),
                            f && (M.setLoadedNode(a, f, "popup"),
                            p.submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                        ...
                        iframe: function(a) {
                            ...
                            a.params.mobile_iframe && (q.setForceTabletStyle(!0),
                            q.setCloseOnOverlayTap(!0),
                            q.setPositionDialogAtTopWhenPortrait(!0));
                            var b = function() {
                        ...
                        touch: function(a) {
                            ...
                            }, 0) : M.iframe(a) : D.nativeApp() && !a.ui_created ? (a.frame = a.id,
                            y.onready(function() {
                        ...
                        async: function(a) {
                            ...
                            H(a.params) || I(a.params) ? (a.params.method = "oauth",
                            a.params.redirect_uri = a.params.next,
                            t.remote.showDialog(a.params, b)) : A.remote.showDialog(a.params, b)
                        },
                        "native": function(a) {
                            z(a.params)
                        },
                        ...
                        _popupMonitor: function() {
                            ...
                            a && !M._popupInterval ? M._popupInterval = setInterval(M._popupMonitor, 100) : !a && M._popupInterval && (clearInterval(M._popupInterval),
                        ...
                        _xdChannelHandler: function(a, b) {
                            ...
                            return E.handler(function(b) {
                                ...
                                if (b.type == "resize")
                                    ...
                                    b.type == "fireevent" && s.fire(b.event, b)
                            }, b, !0, null)
                        },
                        ...
                        _xdRecv: function(a, b) {
                            ...
                            if (c)
                                if (c.close)
                                    ...
                                    r.containsCss(c, "FB_UI_Hidden") ? setTimeout(function() {
                ...
                __d("sdk.ui", ["Assert", "Log", "sdk.feature", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    function a(a, b) {
                        ...
                        g.isObject(a);
                        g.maybeFunction(b);
                        l.getIsVersioned() && (k.assertVersionIsSet(),
                        a.version ? k.assertValidVersion(a.version) : a.version = l.getVersion());
                        a = ES("Object", "assign", !1, {}, a);
                        if (!a.method) {
                        ...
                        var c = a.method;
                        a.redirect_uri && (h.warn("When using FB.ui, you should not specify a redirect_uri."),
                ...
                __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui", "sdk.unsecureDisallowed"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    g.provide("", {
                        ...
                        login: function(a, b) {
                            ...
                            delete b.perms,
                            h.warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));
                ...
                __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    function a(a, b) {
                        b === undefined && typeof a === "number" && (b = a,
                        a = !0),
                        a || a === undefined ? (i === null && (i = setInterval(function() {
                            l()
                        }, b || 100)),
                        l()) : i !== null && (clearInterval(i),
                        i = null)
                    }
                    h.stub("setSize");
                    b = {
                ...
                __d("legacy:fb.canvas", ["Assert", "sdk.Canvas.Environment", "sdk.Event", "FB", "sdk.Canvas.IframeHandling", "sdk.Canvas.Navigation", "sdk.Canvas.Plugin", "sdk.RPC", "sdk.Runtime", "sdk.Canvas.Tti"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                    ...
                    i.subscribe("init:post", function(a) {
                        o.isEnvironment(o.ENVIRONMENTS.CANVAS) && (g.isTrue(!a.hideFlashCallback || !a.hidePluginCallback, "cannot specify deprecated hideFlashCallback and new hidePluginCallback"),
                        m._setHidePluginCallback(a.hidePluginCallback || a.hideFlashCallback))
                    })
                }
                ), 3);
                ...
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig", "sdk.api", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    function a() {
                        if (!i.isEnvironment(i.ENVIRONMENTS.CANVAS) || !i.getClientID() || !k)
                            return;
                        if (Math.random() > 1 / k || l == "*" || ~ES(l, "indexOf", !0, i.getClientID()))
                            return;
                        setTimeout(o, 3e4)
                    }
                    function b(a) {
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.fbt", "sdk.feature", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var n = function() {
                        ...
                        if (!j("js_sdk_mbasic_share_plugin_init", !1))
                            return;
                ...
                __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function s(a) {
                        ...
                        if (o.getIsVersioned()) {
                            ...
                            /number|string/.test(typeof a) && (g.warn("FB.init called with invalid parameters"),
                            a = {
                                apiKey: a
                            }),
                    ...
                    setTimeout(function() {
                        ...
                        window.fbAsyncInit && !window.fbAsyncInit.hasRun && (l.fire("init:asyncstart"),
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    if (l) {
                        ...
                        if (b.length > 1)
                            ...
                            b = null;
                        b && (n.fetchTime = Math.round(b.duration),
                        a && (n.fetchTime += Math.round(a.duration)),
                        "transferSize"in b && (n.transferSize = b.transferSize,
                ...
                __d("XFBML", ["Assert", "Log", "ObservableMixin", "runOnce", "sdk.DOM", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    function t(a) {
                        ...
                        if (b.length === 0)
                            return undefined;
                        if (a.getAttribute("fb-xfbml-state") || !a.childNodes || a.childNodes.length === 0 || a.childNodes.length === 1 && a.childNodes[0].nodeType === 3 || a.children.length === 1 && q(a.children[0], "className") === "fb-xfbml-parse-ignore")
                            return n[b[0]]
                    }
                    function u(a) {
                        var b = {};
                    ...
                    function w(a, b, c) {
                        ...
                        var e = 1
                          ...
                          , i = function() {
                            e--,
                            e === 0 && (h.info("XFBML Parsing Finish %s, %s tags found", d, f),
                            b(),
                            p.inform("render", d, f)),
                        ...
                        ES(ES("Array", "from", !1, a.getElementsByTagName("*")), "forEach", !0, function(a) {
                            __p && __p();
                            if (!c && a.getAttribute("fb-xfbml-state"))
                                return;
                            if (a.nodeType !== 1)
                                return;
                            var b = s(a) || t(a);
                            ...
                            b = function b() {
                                a.getAttribute("fb-xfbml-state") == "parsed" ? p.subscribe("render.queue", b) : (a.setAttribute("fb-xfbml-state", "parsed"),
                                d.process())
                            }
                            ;
                            b()
                ...
                __d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "resolveURI", "sdk.Auth", "sdk.createIframe", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function B(a, b, c, d) {
                        ES(ES("Object", "keys", !1, a), "forEach", !0, function(e) {
                            a[e] == "text" && !c[e] && (c[e] = b.textContent || b.innerText || "",
                    ...
                    var E = j.extend({
                        constructor: function(a, b, c, d) {
                            ...
                            this.isFluid() && g.width !== "auto" && (p.addCss(this._element, "fb_iframe_widget_fluid_desktop"),
                            !g.width && this._config.full_width && (this._element.style.width = "100%",
                            this._iframeOptions.root.style.width = "100%",
                            this._iframeOptions.style.width = "100%",
                            this._params.container_width = this._element.offsetWidth,
                            this._iframeOptions.url = f + i.encode(this._params)))
                        },
                ...
                __d("sdk.XFBML.Comments", ["IframePlugin", "QueryString", "UrlMap", "sdk.DOM", "sdk.Event", "sdk.Runtime", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = 320
                      , o = {
                        numposts: "string",
                    ...
                    function p(a, b) {
                        ...
                        if (!b.href) {
                            ...
                            c = b.fb_comment_id;
                            c || (c = h.decode(document.URL.substring(ES(document.URL, "indexOf", !0, "?") + 1)).fb_comment_id,
                            c && ES(c, "indexOf", !0, "#") > 0 && (c = c.substring(0, ES(c, "indexOf", !0, "#"))));
                            c && (b.fb_comment_id = c)
                        }
                        b.version || (b.version = l.getVersion());
                        b.permalink || (b.width = b.mobile || b.width === "auto" || b.width === "100%" ? "" : b.width ? Math.max(b.width, n) : 550,
                        b.height = 100);
                        return b
                    }
                    a = g.extend({
                ...
                __d("sdk.XFBML.CommentsCount", ["ApiClient", "ObservableMixin", "sdk.DOM", "sprintf"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    a.prototype.process = function() {
                        ...
                        g.scheduleBatchCall("/v2.1/" + encodeURIComponent(this.href), {
                            fields: "share"
                        }, ES(function(a) {
                ...
                __d("sdk.XFBML.CustomerChat", ["IframePlugin", "QueryString", "getDocumentScrollElement", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    a = g.extend({
                        ...
                        _setUpSubscriptions: function() {
                            ...
                            this.subscribe("xd.liveChatPluginPrepareAnchorIframe", ES(function(a) {
                                z = ES("JSON", "parse", !1, a.passesMobileRedesignGK),
                                ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginResizeAnchorIframe", ES(function(a) {
                                this._handleResizeAnchorIframe(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginExpandDialogIframe", ES(function(a) {
                                ES("JSON", "parse", !1, a.isMobile) ? this._handleExpandMobileDialogIframe(a) : this._handleExpandDesktopDialogIframe(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginShowInterstitialOnPage", ES(function(a) {
                                this._handleShowInterstitialOnPage(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginShowDialogIframe", ES(function(a) {
                                this._handleShowDialogIframe(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginHideDialogIframe", ES(function(a) {
                                this._handleHideDialogIframe(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginUpdateShadow", ES(function(a) {
                                this._handleShadowUpdate(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginUpdatePageTitle", ES(function(a) {
                                this._handleUpdatePageTitle(a)
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginExpandMobilePrompt", ES(function(a) {
                                this._handleExpandMobilePrompt()
                            }, "bind", !0, this)),
                            q.iphone() && (this.subscribe("xd.liveChatPluginFocusComposer", ES(function(a) {
                                this._handleFocusComposer()
                            }, "bind", !0, this)),
                            this.subscribe("xd.liveChatPluginBlurComposer", ES(function(a) {
                                this._handleBlurComposer()
                            }, "bind", !0, this)))
                        },
                        _handleGetBubbleIframe: function(a) {
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe),
                            v = this._bubbleDialog,
                            j.append(this._bubbleDialog),
                            this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function(a) {
                                n.setStyle(this._bubbleDialog, "display", "inline"),
                                u && (n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_pop_in"),
                                ES("JSON", "parse", !1, a.dialogHidden) || setTimeout(ES(function() {
                                    D = !1,
                                    G(this._iframe, w, q.mobile())
                                }, "bind", !0, this), 750)),
                                ES("JSON", "parse", !1, a.showBadge) && this._setBubbleBadgeStyle()
                            }, "bind", !0, this))
                        },
                        _handlePrepareDesktopAnchorIframe: function(a) {
                            ...
                            ES("JSON", "parse", !1, a.chatStarted) && (w = !0,
                            ES("Object", "assign", !1, this._iframe.style, {
                                height: "378pt"
                            })),
                            x = this._iframe)
                        ...
                        _handleShowInterstitialOnPage: function(a) {
                            !ES("JSON", "parse", !1, a.dialogHidden) ? (H(this._iframe, !1, !0, !1),
                            setTimeout(ES(function() {
                                this._makeDialogIframeFullScreen(),
                                C = !0,
                                G(this._iframe, !1, !0, !0),
                                E()
                            }, "bind", !0, this), 500)) : (this._makeDialogIframeFullScreen(),
                            C = !0,
                            G(this._iframe, !1, !0, !0))
                        },
                        _handleShadowUpdate: function(a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (n.setStyle(this._bubbleDialog, "borderRadius", "50%"),
                            u ? n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge") : n.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)")) : ES("JSON", "parse", !1, a.resetShadow) || this._setBubbleBadgeStyle()
                        },
                        _handleUpdatePageTitle: function(a) {
                            !t && a.titleText ? (t = m.blink(a.titleText),
                            o.add(window, "focus", ES(function(a) {
                                this._stopBlinking()
                        ...
                        _handleFocusComposer: function() {
                            setTimeout(ES(function() {
                                var a = i();
                                a && (n.setStyle(this._iframe, "maxHeight", a.scrollHeight - a.scrollTop + "px"),
                                a.scrollTo(0, 0))
                            }, "bind", !0, this), 700)
                        },
                        ...
                        _setupNewIframeDialog: function(a) {
                            ...
                            u ? (n.removeCss(b.dialogElement, "fb_customer_chat_bubble_animated_with_badge"),
                            n.addCss(b.dialogElement, "fb_customer_chat_bubble_animated_no_badge")) : n.setStyle(b.dialogElement, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                            return b.dialogElement
                        },
                        _setBubbleBadgeStyle: function() {
                            this._bubbleDialog && (n.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"),
                            u ? (n.removeCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge"),
                            n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_with_badge")) : n.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"))
                        },
                        ...
                        _makeDialogIframeFullScreen: function() {
                            this._iframe && (n.setStyle(this._iframe, "boxShadow", "none"),
                    ...
                    function G(a, b, c, d) {
                        ...
                        if (D === null || D === !1) {
                            c && (b || z && C) && E();
                            if (u) {
                                c && (b || z && C) ? (c = "fb_customer_chat_bounce_in_v2_mobile_chat_started",
                                b = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (c = "fb_customer_chat_bounce_in_v2",
                        ...
                        if (D === null || D === !0) {
                            ...
                            if (!u)
                                ...
                                var f = function a(d) {
                                    ...
                                    d.animationName === f && (n.setStyle(e, "maxHeight", "0"),
                                    ES(s, "forEach", !0, function(event) {
                                        o.remove(e, event, a)
                                    }))
                                }, g;
                                c && (b || z && C) ? (a = "fb_customer_chat_bounce_in_v2_mobile_chat_started",
                                g = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (a = "fb_customer_chat_bounce_in_v2",
                    ...
                    a = g.extend({
                        constructor: function(a, b, c, d) {
                            ...
                            this.subscribe("xd.savePluginGetBlankIframe", ES(function(a) {
                                ...
                                e && (b = k.setupNewDarkOverlay(),
                                g(b),
                                i.append(b),
                                k.addDoubleClickAction(b, function() {
                                ...
                                this.subscribe("xd.savePluginShowIframe", ES(function() {
                                    ...
                                    !e && !j && (j = k.addIdleDesktopAction(c, h, 7e3))
                                }, "bind", !0, this));
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4418441","namespace":"FB","message":"' + e.message + '"}}');
}
